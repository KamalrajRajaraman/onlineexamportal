...
public class ExamTopicMappingMasterEvents {
	...
	public static String createExamTopicMappingMasterRecord(HttpServletRequest request, HttpServletResponse response) {
		...
		String questionPerExam = (String) request.getAttribute(CommonConstant.QUESTION_PER_EXAM);
		...
		if (questionPerExam == null) {
			questionPerExam = request.getParameter(CommonConstant.QUESTION_PER_EXAM);
		}
